...
class CallTypes():
    ...
    SearchResult = CallTypeMeta('SearchResult',
                                'q', 'page__int')
    SearchResultByAuthor = CallTypeMeta('SearchResultByAuthor',
                                        'author_id', 'page__int')
    BookDetail = CallTypeMeta('BookDetail',
                              'book_id', 'q')
    ToFavorites = CallTypeMeta('ToFavorites',
                               'book_id')
    BookDownload = CallTypeMeta('BookDownload', 'id',
                                'f', 'u')
    Subscribed = CallTypeMeta('Subscribed')
